      ...
      <div className="container d-flex justify-content-between align-items-center">
        <a href="#" className="d-flex align-items-center text-decoration-none">
          ...
          <span
            ...
            style={{ fontFamily: "'Catamaran', sans-serif", fontSize: "2.8rem", color: "#fd3d0d" }}
          >
            Crossfit
          </span>
        </a>
            ...
            {navItems.map((text, idx) => (
              <li key={idx} className="nav-item">
                <a
                  ...
                  style={{
                    color: hoveredIndex === idx ? '#fd3d0d' : 'white',
                    textDecoration: 'none',
  ...
  >
    ...
    >
      <div className="text-center text-lg-start mb-5 mb-lg-0">
        ...
        >
          <strong className="bg-danger px-3 rounded me-3 hero-subtitle">The Best</strong>Fitness Club
        </p>
      ...
      <div className="position-relative mx-auto hero-banner " style={{ maxWidth: 660 }}>
        <img
...
const About = () => (
  <section id="about" aria-label="about" className="section about py-5">
    <div
      className="container d-lg-grid"
      style={{ gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "center" }}
    >
      <div className="about-banner has-after position-relative mb-4 mb-lg-0">
        <img
...
const Video = () => (
  <section
    className="section video py-5 position-relative bg-dark text-white overflow-hidden"
    aria-label="video"
    style={{
      backgroundImage: "url('/assets/images/hero-bg.png')",
      backgroundRepeat: "no-repeat",
...
const Classes = () => {
  ...
  return (
    ...
    >
      <Container>
        <p className="section-subtitle text-center fw-bold mb-2" style={{ fontFamily: "'Catamaran', sans-serif" }}>
          Our Classes
        </p>
        ...
        >
          {classesList.map(({ img, alt, icon, title, text, progress }) => (
            <div
              key={title}
              className="class-card bg-white rounded shadow-sm d-flex flex-column"
              style={{
                minWidth: "320px",
                maxWidth: "340px",
                flex: "0 0 auto",
  ...
  return (
    <footer className="footer bg-dark text-light pt-5">
      ...
      >
        ...
        >
          ...
          <div className="footer-brand">
            <a
              href="#"
              className="d-flex align-items-center text-light text-decoration-none mb-3"
            >
              <ion-icon
                name="barbell-sharp"
                style={{
            ...
            <p
              className="footer-brand-text  mb-4"
              style={{ maxWidth: 300 }}
            >
          ...
          {/* Our Links */}
          <div>
            <p className="footer-list-title fw-bold mb-4 position-relative text-center">
              Our Links
            </p>
          ...
          <div id="contactus">
            <p
              className="footer-list-title fw-bold mb-4 position-relative text-center"
              style={{
                fontFamily: "'Catamaran', sans-serif",
                fontSize: "1.5rem",
              }}
            ...
            <ul className="list-unstyled">
              <li className="footer-list-item d-flex align-items-center mb-3 gap-3">
                <ion-icon
                  ...
                  style={{ color: "#fd3d0d", fontSize: 22 }}
                />
                <address
                  className="address footer-link mb-0"
                  style={{ fontStyle: "normal" }}
                >
                  metiit, bandra, mumbai
                </address>
              </li>
              <li className="footer-list-item d-flex align-items-center mb-3 gap-3">
                <ion-icon
                ...
                <div>
                  <a
                    ...
                    className="footer-link d-block text-light text-decoration-none"
                  >
                    1800-121-3637
                  </a>
                  <a
              ...
              <li className="footer-list-item d-flex align-items-center gap-3">
                ...
                <div>
                  <a
                    href="mailto:info@Crossfit.com"
                    className="footer-link d-block text-light text-decoration-none"
                  >
                    info@Crossfit.com
                  </a>
                  <a
                    href="mailto:services@Crossfit.com"
                    className="footer-link d-block text-light text-decoration-none"
                  >
                    services@Crossfit.com
                  </a>
                </div>
              </li>
            </ul>
          ...
          <div>
            ...
            <form action="" className="footer-form position-relative mb-4">
              ...
              <button
                type="submit"
                className="btn btn-danger position-absolute top-50 end-0 translate-middle-y rounded-circle"
                aria-label="Submit"
                style={{
                  width: 40,
                  height: 40,
            ...
            <ul className="social-list d-flex gap-3 list-unstyled justify-content-center">
              {["logo-facebook", "logo-instagram", "logo-twitter"].map(
                (icon, idx) => (
                  <li key={idx}>
                    <a
                      href="#social"
        ...
        <div className="container d-lg-flex justify-content-between align-items-center">
          <p className="mb-2 mb-lg-0" style={{ fontSize: "0.9rem" }}>
            ...
            <a
              ...
              className="copyright-link text-danger text-decoration-none"
            >
              CDAC
            </a>
            . All Rights Reserved.
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <a
              href="#privacy"
              className="footer-bottom-link text-light text-decoration-none"
            >
              Privacy Policy
            </a>
            <span className="text-danger">●</span>
      ...
      <Button
        ...
        className="position-fixed bottom-0 end-0 m-4 bg-danger text-white rounded-circle d-flex justify-content-center align-items-center"
        style={{
          width: "52px",
          height: "52px",
